...
def create_prompt(note, prompt_config):
    ...
    if len(field_names) == 0:
        logger.warning("No field names are found in the request %s", prompt_template)
